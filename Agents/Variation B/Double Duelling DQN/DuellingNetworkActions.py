...
class DuellingBoardDeepQnetwork(nn.Module):
    def __init__(self,lr,n_actions,name,input_dims,chkpt_dir):
        super(DuellingBoardDeepQnetwork,self).__init__()
        ...
        if input_dims[1]>8:
            ...
            self.conv1=nn.Conv2d(input_dims[0],32,2)
    ...
    def load_checkpoint(self,i):
        ...
        self.load_state_dict(T.load(self.checkpoint_file+str(i)))
